...
### 碰撞 / Collision Profile
- **碰撞层级说明** → `Docs/笔记/碰撞层级说明.md`
- **碰撞采样组件** → `Src/ECS/Component/Collision/CollisionSensorComponent/CollisionSensorComponent.cs`
...
- **Collision Profile 脚本与模板** → `Src/ECS/Component/Collision/Profile/`
- **关键约定**：生成器把 `Collision` 挂到 `VisualRoot`；运行时再回填到真实物理节点和组件
